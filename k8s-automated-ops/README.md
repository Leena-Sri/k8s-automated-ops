...
A production-style Python CLI tool for Kubernetes workload discovery, health monitoring, and automated remediation. This project demonstrates skills relevant to a Canonical Software Engineer – Python and Kubernetes interview.
...
This project is designed as a demonstration for technical interviews. Contributions are welcome but should maintain the project's focus on simplicity and educational value.
